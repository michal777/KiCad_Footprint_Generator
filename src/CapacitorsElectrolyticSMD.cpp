...
CapacitorsElectrolyticSMD::CapacitorsElectrolyticSMD() {
...
void CapacitorsElectrolyticSMD::ReadParameters(char table[100][100][500], int row) {
	int column;
...
void CapacitorsElectrolyticSMD::CalcLandPattern(void) {
	double F;
	double P;
	double j_t;
	double j_h;
...
void CapacitorsElectrolyticSMD::CalcAssemblyScale(void) {
...
void CapacitorsElectrolyticSMD::GeneratePads(FILE* footprint_file) {
...
void CapacitorsElectrolyticSMD::PrintFootprint(FILE* footprint_file) {
...
void CapacitorsElectrolyticSMD::GenerateAssembly(FILE* footprint_file, double assem_scale) {
	double start_line_x;
	double end_line_x;
	double start_line_y;
	double end_line_y;
...
void CapacitorsElectrolyticSMD::GenerateCourtyard(FILE* footprint_file) {
	double start_line_x;
	double end_line_x;
	double start_line_y;
	double end_line_y;

	start_line_y = end_line_y = MAX (body_width_max / 2 + CRTYD_CLEARANCE_2, body_width_max / 2 + 1.5 * SILKS_LINE_WIDTH);
	start_line_x = (pad_dist + pad_length) / 2 + CRTYD_CLEARANCE_2;
...
void CapacitorsElectrolyticSMD::GenerateSilkScreen(FILE* footprint_file) {
	double start_line_x;
	double end_line_x;
	double start_line_y;
	double end_line_y;

...
ResistorsChipSMD::ResistorsChipSMD() {
...
void ResistorsChipSMD::ReadParameters(char table[100][100][500], int row) {
	int column;
...
void ResistorsChipSMD::CalcLandPattern(void) {
	double F;
	double P;
	double j_t;
	double j_h;
...
void ResistorsChipSMD::CalcAssemblyScale(void) {
...
void ResistorsChipSMD::GeneratePads(FILE* footprint_file) {
...
void ResistorsChipSMD::PrintFootprint(FILE* footprint_file) {
...
void ResistorsChipSMD::GenerateAssembly(FILE* footprint_file, double assem_scale) {
	double start_line_x;
	double end_line_x;
	double start_line_y;
	double end_line_y;
...
void ResistorsChipSMD::GenerateCourtyard(FILE* footprint_file) {
	double start_line_x;
	double end_line_x;
	double start_line_y;
	double end_line_y;
...
void ResistorsChipSMD::GenerateCourtyardSilkScreenOutline(FILE* footprint_file) {
	double start_line_x;
	double end_line_x;
	double start_line_y;
	double end_line_y;
...
void ResistorsChipSMD::GenerateCourtyardNoSilkScreen(FILE* footprint_file) {
	double start_line_x;
	double end_line_x;
	double start_line_y;
	double end_line_y;
...
void ResistorsChipSMD::GenerateSilkScreen(FILE* footprint_file) {
	double start_line_x;
	double end_line_x;
	double start_line_y;
	double end_line_y;
...
void ResistorsChipSMD::GenerateSilkScreenOutline(FILE* footprint_file) {
	double start_line_x;
	double end_line_x;
	double start_line_y;
	double end_line_y;
...
void ResistorsChipSMD::GenerateSilkScreenMinimal(FILE* footprint_file) {
	double start_line_x;
	double end_line_x;
	double start_line_y;
	double end_line_y;

...
SocketStripsStraight::SocketStripsStraight() {
	pads_rows_spacing = 0;
	pads_per_row = 0;
	rows_count = 0;
	pitch = 0;
...
void SocketStripsStraight::ReadParameters(char table[100][100][500], int row) {
	int column;
...
void SocketStripsStraight::CalcAssemblyScale(void) {
...
void SocketStripsStraight::GeneratePads(FILE* footprint_file) {
...
void SocketStripsStraight::PrintFootprint(FILE* footprint_file) {
...
void SocketStripsStraight::GenerateAssembly(FILE* footprint_file, double assem_scale) {
	double start_line_x;
	double end_line_x;
	double start_line_y;
	double end_line_y;
...
void SocketStripsStraight::GenerateCourtyard(FILE* footprint_file) {
	double start_line_x;
	double end_line_x;
	double start_line_y;
	double end_line_y;
...
void SocketStripsStraight::GenerateSilkScreen(FILE* footprint_file) {
	double start_line_x;
	double end_line_x;
	double start_line_y;
	double end_line_y;
...
void SocketStripsStraight::CalcOffset(void) {
